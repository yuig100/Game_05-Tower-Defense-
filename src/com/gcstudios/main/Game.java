...
public class Game extends Canvas implements Runnable,MouseListener,MouseMotionListener{
	...
	public Game(){
		...
		ui = new UI();
		tower1 = new TowerController(0,0,0,0,0,null);
	}
	...
	public void render(){
		...
		g.drawImage(Game.spritesheet.getSprite(0, 0, 16, 16),0, 0, WIDTH, HEIGHT,null);
	...
	public void mousePressed(MouseEvent e) {	
		...
		if(gold >= 100) {
			...
			tower1.isPressed=true;
			tower1.xTarget = e.getX() / 3;
			tower1.yTarget = e.getY() / 3;
